...
exports.seed = function(knex, Promise) {
  // Deletes ALL existing entries
      return Promise.all([
        ...
        knex('todos').insert({item: 'THE WIZARD OF OZ', user_id: '4', category_id: '1', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'CITIZEN KANE', user_id: '4', category_id: '1', date_entered: knex.fn.now(), completed: 'f'}),
        ...
        knex('todos').insert({item: 'Harry Potter and the Sorcerer\'s Stone', user_id: '5', category_id: '3', date_entered: knex.fn.now(), completed: 'f'}),
        ...
        knex('todos').insert({item: 'Charlotte\'s Web', user_id: '5', category_id: '3', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'Bonterra', user_id: '5', category_id: '2', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'River Cafe', user_id: '5', category_id: '2', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'Phil & Sebastian\'s', user_id: '6', category_id: '2', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'ALL ABOUT EVE', user_id: '6', category_id: '1', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'THE GODFATHER', user_id: '6', category_id: '1', date_entered: knex.fn.now(), completed: 'f'}),
