...
exports.seed = function(knex, Promise) {
  // Deletes ALL existing entries
      return Promise.all([
        ...
        knex('todos').insert({item: 'WIZARDOFOZ', user_id: '4', category_id: '1', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'CITIZENKANE', user_id: '4', category_id: '1', date_entered: knex.fn.now(), completed: 'f'}),
        ...
        knex('todos').insert({item: 'RiverCafe', user_id: '5', category_id: '2', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'Phil&Sebastians', user_id: '6', category_id: '2', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'ALLABOUTEVE', user_id: '6', category_id: '1', date_entered: knex.fn.now(), completed: 'f'}),
        knex('todos').insert({item: 'GODFATHER', user_id: '6', category_id: '1', date_entered: knex.fn.now(), completed: 'f'}),
